...
#   Ex: fontforge -script eaa2narrow.py source/fontforge_export_BIZUDGothic-Regular.ttf UDEAWH Regular 0.0.1 source/NotoEmoji/static/NotoEmoji-Regular.ttf source/dejavu-fonts-ttf-2.37/ttf/DejaVuSansMono.ttf
import datetime
import math
import sys
import fontforge
...
def add_emoji2(f, halfWidth, emojifontfile2):
    ...
    for ucode in (0x260f,  # Ambiguous。NotoEmojiに無い
                  ...
                  # NotoEmojiだと枠付き
                  0x2195, 0x2626, 0x262a, 0x262e, 0x262f, 0x2638, 0x267e,
                  0x269b, 0x271d, 0x2721,):
        g = emojifont2[ucode]
        narrow(g, halfWidth)
