...
def main(fontfile, fontfamily, fontstyle, version, emojifontfile, emojifontfile2):
    ...
    scalexy(font[0x25B2], halfWidth)  # black up-pointing triangle(▲)
    scalexy(font[0x25B3], halfWidth)  # white up-pointing triangle(△)
    scalexy(font[0x25BC], halfWidth)  # black down-pointing triangle(▼)
    scalexy(font[0x25BD], halfWidth)  # white down-pointing triangle(▽)
